/*
 ...
 Event (e) — це об'єкт, який автоматично передається у функцію eventListener (обробник події) в JavaScript.
 ...
 Він містить всю інформацію про подію, яка щойно відбулася, наприклад:
  ...
  ◦ координати миші (для подій з мишею);
  ◦ натиснуту клавішу (для подій з клавіатурою);

  ◦ методи, як-от preventDefault() або stopPropagation(), stopImmediatePropagation()


Event Phases

  1. Capture phase (фаза захоплення)
