...
export function createUpdateForm(todo, li) {
    li.innerHTML = `
       <form class='form form_update update-form'>
          <label>
               <input type='checkbox' class='toggle-checkbox' ${todo.checked ? 'checked' : ''}>
          </label>
          <div>
